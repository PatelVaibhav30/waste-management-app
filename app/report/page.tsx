...
export default function ReportPage() {
    ...
    const handleVerify = async () => {
        ...
        try {
            const genAI = new GoogleGenerativeAI(geminiApiKey); //IF ANY CASE KEY DOESN'T WORK GENERATE NEW KEY
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const report = await createReport(user.id, newReport.location, newReport.type, newReport.amount, preview || undefined, verificationResults ? JSON.stringify(verificationResults) : undefined) as any;
            ...
            toast.error("Failed to sbmit report. Please try again.")
        } finally {
    ...
    return (
        <div className="p-8 max-w-4xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="bg-white p-8 rounded-2xl shadow-lg mb-12">
                ...
                {verificationStatus === 'success' && verificationResults && (
                        ...
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <div className="mt-2 text-sm text-green-700">
                                    ...
                                    <p>Confidence: {(verificationResults.confidence * 100).toFixed(2)}%</p>
                                </div>
                            </div>
                        </div>
                    </div>
