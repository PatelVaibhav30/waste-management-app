  ...
  useEffect(() => {
    const updateLoginInfo = async () => {
      if (session && session.user) {
        ...
        try {
          await createUser(session.user.email || '', session.user.name || 'Anonymous user');
        } catch (e) {
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      if (userInfo && userInfo.email) {
        ...
        if (user) {
          const unreadNotifications: any = await getUnreadNotifications(user.id);
            ...
            !loggedIn ? (
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align='end'>
                  ...
                  // onClick={getUserInfo}
                  >
                    {userInfo ? userInfo.name : "Test Profile"}
                  </DropdownMenuItem>
